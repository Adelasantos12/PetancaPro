      ...
      >
        ...
        >
          ...
          <p className="text-gray-600 mb-6 text-center">
            Si esta app te ahorró tiempo o dolores de cabeza, ¡devuélvele un tiro! 😄. Te invitamos a hacer una aportación voluntaria. La cantidad sugerida es de <span className="font-bold">${donationAmount}</span> ({playerCount} jugadores x $2 USD).
          </p>
